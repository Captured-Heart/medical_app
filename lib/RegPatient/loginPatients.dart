...
class LoginPagePatients extends StatefulWidget {
  @override
  _LoginPagePatientsState createState() => _LoginPagePatientsState();
}

class _LoginPagePatientsState extends State<LoginPagePatients> {
  @override
                    ...
                    FaceBookLoginButton(
                      ...
                      press: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => LoginPatientEmail()),
                        );
                      },
                    ),
                  ],
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListTile(
                        ...
                        title: Text('Go to therapist version'))
                  ],
                ),
              ),
              SizedBox(height: 30)
